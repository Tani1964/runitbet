            ...
            <div className="md:w-1/2 bg-blue-600 p-8 md:p-12 lg:p-16 text-white">
              ...
              {formStatus.submitted ? (
                ...
                <form ref={form} onSubmit={sendEmail} className="space-y-4">
                  {formStatus.message && (
                    <div className={`${formStatus.error ? 'bg-red-100 text-red-700 border-red-400' : 'bg-blue-100 text-blue-700 border-blue-400'} border px-4 py-3 rounded relative mb-4`}>
                      <p>{formStatus.message}</p>
                    </div>
                  )}
                  <div>
